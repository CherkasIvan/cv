...
export class FirebaseService {
    ...
    getFrontendTech(): Observable<ITechnologies[]> {
        this.frontendTechCollection$ = collectionData(collection(this._firestore, 'frontendTech'), {
            idField: 'id',
    ...
    getBackendTech(): Observable<ITechnologies[]> {
        this.backendTechCollection$ = collectionData(collection(this._firestore, 'backendTech'), {
            idField: 'id',
        }) as Observable<ITechnologies[]>;
    ...
    getSocialTech(): Observable<ITechnologies[]> {
        this.socialTechCollection$ = collectionData(collection(this._firestore, 'socialTech'), {
            idField: 'id',
        }) as Observable<ITechnologies[]>;
    ...
    getProjectTech(): Observable<ITechnologies[]> {
        this.projectTechCollection$ = collectionData(collection(this._firestore, 'projectTech'), {
            idField: 'id',
        }) as Observable<ITechnologies[]>;
    ...
    getOtherTech(): Observable<ITechnologies[]> {
        this.otherTechCollection$ = collectionData(collection(this._firestore, 'otherTech'), {
            idField: 'id',
        }) as Observable<ITechnologies[]>;
    ...
    getContacts(): Observable<IContacts[]> {
        this.contactsCollection$ = collectionData(collection(this._firestore, 'contacts'), {
            idField: 'id',
    ...
    getNavigation(): Observable<INavigation[]> {
        this.navigationCollection$ = collectionData(collection(this._firestore, 'navigation'), {
            idField: 'id',
    ...
    getCvFormat(): Observable<ICvFormat[]> {
        this.cvFormatCollection$ = collectionData(collection(this._firestore, 'cvFormat'), {
            idField: 'id',
    ...
    getMyProfilePhotos(): Observable<IProfilePhoto[]> {
        this.profilePhotosCollection$ = collectionData(collection(this._firestore, 'profilePhotos'), {
            idField: 'id',
    ...
    getSocialMediaLinks(): Observable<ISocialMedia[]> {
        this.socialMediaLinksCollection$ = collectionData(collection(this._firestore, 'socialMediaLinks'), {
            idField: 'id',
    ...
    getWorkExperience(): Observable<IWorkExperience[]> {
        this.workExperienceCollection$ = collectionData(collection(this._firestore, 'workExperience'), {
            idField: 'id',
    ...
    getEducation(): Observable<IEducation[]> {
        this.educarionCollection$ = collectionData(collection(this._firestore, 'education'), {
            idField: 'id',
